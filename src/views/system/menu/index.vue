  ...
  <div class="app-container">
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU"
      ...
      <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item v-if="form.type.toString() !== '2'" label="平台类型" prop="platform">
          <el-select v-model="form.platform" placeholder="请选择平台类型" style="width: 450px;">
            <el-option label="所有平台" :value=0></el-option>
            <el-option label="期货平台" :value=1></el-option>
            <el-option label="股票平台" :value=2></el-option>
          </el-select>
    ...
    >
      ...
      <el-table-column :show-overflow-tooltip="true" prop="platform" label="平台类型"/>
...
export default {
  ...
  cruds() {
    return CRUD({title: '菜单', url: 'system/menus/', crudMethod: {...crudMenu}})
  },
