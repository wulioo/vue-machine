      ...
      <el-col :md="6">
        <el-card style="min-height:260px;width: 405px">
          <el-upload
            ...
            :action="baseUrl + 'equity/review/ndcg'"
            :data="{&quot;periods&quot;:checkedLabel,&quot;earnings_fun&quot;:earnings_fun}"
            multiple
          >
    ...
    <el-row v-if="factor_item" :gutter="20" style="margin-top: 20px;margin-bottom: 20px">
      <el-col class="mb20">
        <el-card class="box-card">
          ...
          <el-table :data="table_label" stripe style="width: 100%;margin-bottom:10px;" height="500">
            <el-table-column
...
export default {
  ...
  methods: {
    ...
    handleLabelClick(label) {
      this.labels = label
      const that = this
      const parma = { 'table_name': that.t_name, 'factor_label': that.labels }
      that.$api.factor.getNdcg(parma).then(res => {
        that.table_label = res.data
      })
    }
  }
}
